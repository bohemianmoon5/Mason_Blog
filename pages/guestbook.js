...
const Guestbook = () => {
  ...
  return (
    <main className="container mx-auto p-4">
      <Head>
        <title>Guestbook - Mason Na</title>
      </Head>
      <div className="mt-5 flex items-center p-2">
        <input
          ...
          className="border-mint-500 focus:border-mint-700 flex-grow rounded-l-md border bg-gray-200 py-2 px-4 text-lg text-gray-800 focus:outline-none"
        />
        <button
          onClick={uploadData}
