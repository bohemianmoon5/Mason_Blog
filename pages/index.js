...
import Image from '/static/images/memoji01.png'
...
export default function Home({ posts }) {
  ...
  React.useEffect(() => {
    const options = {
      strings: ['I love running', 'I love movies', 'I love music', 'I love myself'],
      typespeed: 10,
      backspeed: 10,
      loop: true,
      showCursor: true,
    ...
    <>
      ...
      <div className="divide-y divide-gray-200 dark:divide-gray-700">
        <div className="space-y-2 pt-6 pb-8 text-center md:space-y-5">
          ...
          <h1 className="mt-6 text-left text-3xl font-extrabold text-gray-700 dark:text-gray-300">
            Latest
          </h1>
